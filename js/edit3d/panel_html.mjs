...
${wide('data-op="quickClean"', "Quick clean up", "The three fixes every AI model needs, in order and in one press: Remove inside surfaces, Fill small holes, Remove loose bits. It counts as one step, so one Undo takes all three back. Example: the first thing to press on a fresh Pixal3D or Trellis 2 model.")}
...
${wide('data-op="fillSmall"', "Fill small holes", "Closes every hole of up to 16 edges and leaves big openings alone. Close a big one with the Fill hole tool in Polygons mode.", '<span class="pix-e3d-badge" data-el="holeBadge"></span>')}
